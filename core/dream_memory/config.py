...
class DreamMemoryConfig:
    ...
    tap_delay: float = 0.15
    tap_between_delay: float = 0.2
    tap_between_delay_min: float = 0.2
    tap_between_delay_max: float = 0.2
    tap_between_delay_mode: float = 0.2
...
def _build_config(raw: dict, *, pk: bool) -> DreamMemoryConfig:
    ...
    if pk:
        ...
        timing = dict(
            ...
            tap_between_delay_max=0.2,
            tap_between_delay_mode=0.2,
            tap_between_interval=TAP_INTERVAL_FIXED,
            scan_interval=0.3,
    ...
    cfg = DreamMemoryConfig(
        ...
        tap_delay=float(raw.get("tap_delay", 0.15)),
